...
public interface BookingService {
    ...
    List<BookingDtoToReturn> getAllBookingsByUser(Long userId, BookingStatusState state);

    List<BookingDtoToReturn> getAllBookingsByOwner(Long ownerId, BookingStatusState state);
}
